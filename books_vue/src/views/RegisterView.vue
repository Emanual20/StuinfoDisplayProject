        ...
        <form @submit.prevent="blockedregister()">
          <div class="mb-3">
            ...
            <div id="emailHelp" class="form-text">
              <b>The email address will be set as your login username.</b>
            </div>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <div id="PasswordHelp" class="form-text">
              <b
                ...
                characters. The Password shall pass automatically security
                check.</b
              >
            </div>
            <br />
    ...
    tryregister() {
      ...
      RegisterUserPost(testParams)
        ...
        .catch(err => {
          ...
          let error_message =
            "Internal server error or this email already exists..";
          alert(error_message);
        });
    }
  }
