      ...
      <div class="card-body">
        <div class="personalinfo">
          ...
          <div class="bachelorgroup">
            ...
            <br />
            <label for="basic-url" class="form-label"
              >以下内容带*的内容为<b>必填项</b>，其余不设置合法检查，可根据提示填写（悄悄告诉你，带星的不写也没关系，因为我懒得写Validation了！！)</label
            >
            <br />
              ...
              <div class="col-12">
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="gridCheck">
                    <b
                      >我同意将上述信息供网站使用，根据自己设定的权限展示给其他同学。</b
                    >
                  </label>
                </div>
              </div>
