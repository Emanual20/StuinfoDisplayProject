<template>
  <b-container id="header">
    <b-navbar toggleable="lg" type="dark" variant="info">
      <b-navbar-brand href="/">NKH15-2-Stuinfo</b-navbar-brand>
      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        <ul class="navbar-nav ml-auto" v-else>
          ...
          <a class="nav-link" @click="manageinfo()"> 更新个人信息 </a>
          <a class="nav-link" @click="checkstuinfo()"> 查看他人信息 </a>
          <a class="nav-link" @click="manageperm()"> 权限管理 </a>
          <a class="nav-link" @click="checkspitslot()"> 我要吐槽 </a>
